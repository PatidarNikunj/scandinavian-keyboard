 ...
 */
public class Suggest2 implements Dictionary2.WordCallback {

    public static final int CORRECTION_NONE = 0;
    public static final int CORRECTION_BASIC = 1;
    public static final int CORRECTION_FULL = 2;
    
    private Dictionary2 mMainDict;
    
    private Dictionary2 mUserDictionary;

    private Dictionary2 mAutoDictionary;
    ...
    public Suggest2(Context context, Resources res, int dictionaryResId) {
        mContext = context;
        mMainDict = new BinaryDictionary2(res, dictionaryResId);
     ...
     */
    public void setUserDictionary(Dictionary2 userDictionary) {
        mUserDictionary = userDictionary;
    }

    public void setAutoDictionary(Dictionary2 autoDictionary) {
