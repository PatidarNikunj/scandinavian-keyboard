...
public class Suggest implements Dictionary.WordCallback {
    ...
    public Suggest(Context context,Resources res, int dictionaryResId) {
        mMainDict = new BinaryDictionary(context, res, dictionaryResId, DIC_MAIN);
        initPool();
    }

    public Suggest(Context context, Resources res,ByteBuffer byteBuffer) {
        initPool();
    }
    ...
    public List<CharSequence> getSuggestions(View view, WordComposer wordComposer, 
        ...
        //Log.i("Suggest","Original word:" + wordComposer.getTypedWord().toString());
        ...
        if (wordComposer.size() == 1 && (mCorrectionMode == CORRECTION_FULL_BIGRAM
            ...
            //Log.i("Suggest","Bigrams Suggestions size:" + mBigramSuggestions.size());
            if (!TextUtils.isEmpty(prevWordForBigram)) {
                ...
                //Log.i("Suggest","BigramSuggestionSize" + mBigramSuggestions.size());
            ...
            //Log.i("Suggest","Wordcomposer size:" + wordComposer.size());
            ...
            //Log.i("Suggest","Maindict:" + mMainDict.getSize());
        ...
        removeDupes();
        //Log.i("Suggest","HaveCorrection:" + mHaveCorrection);
        //Log.i("Suggest","Suggestions:" + mSuggestions.size());
        return mSuggestions;
    }
    ...
    private int searchBigramSuggestion(final char[] word, final int offset, final int length) {
        ...
        //Log.i("Suggest", "SearchBigram failed");
        return -1;
    }
